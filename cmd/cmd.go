...
func init() {
	...
	rootCmd.Flags().StringSliceVar(&bbOpts.AdditionalOverrideNames, "additional-override-names", nil, "A comma seprated list of names that will be used to create additional optional configmaps and secrets that will be appended to the 'bigbang' flux helmrelease valuesFrom list.")
}
